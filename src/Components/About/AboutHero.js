...
const AboutHero = () => {
    return (
        <div className='container my-3 lg:my-10 mx-auto bg-gradient-to-l rounded-3xl from-[#c7d2dde0] to-[#e4e9ee8f] '>
            <Header />
            <div className='grid md:grid-cols-2  gap-10 p-5'>
                <div>
                    <div className='main_text_animation'>
                        <h2 className='clip-text text-primary text-3xl lg:text-[100px] leading-[1.1] font-bold'>ABOUT us ZimriTech</h2>
                    </div>
                ...
                <div className='w-full min-h-[70vh] rounded-3xl bg-[url("/Images/about/robot_about.png")] bg-no-repeat bg-center bg-cover relative'>
                    <img
                        className='absolute animate-rotate-clockwise lg:-left-20 left-0 top-0 xl:w-48 w-32 bottom-0'
